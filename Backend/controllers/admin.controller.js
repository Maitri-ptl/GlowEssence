...
// update any user's details (admin doesn't need to BE that user, unlike
// the regular /api/user/update/:id route which only lets you edit yourself)
// PATCH : /api/admin/users/:id
export const updateUserByAdmin = async (req, res) => {
    try {
        const { id } = req.params;

        // admin should not accidentally overwrite the password through this form
